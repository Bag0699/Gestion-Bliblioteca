...
import com.bag.gestion_biblioteca.service.PenaltyService;
...
public class PenaltyController {
    ...
    @PostMapping
    public ResponseEntity<PenaltyResponse> save(@Valid
                                                @RequestBody
                                                CreatePenaltyRequest request){
    ...
    @PutMapping("/{id}")
    public PenaltyResponse update(@PathVariable Long id,
                                  @Valid
